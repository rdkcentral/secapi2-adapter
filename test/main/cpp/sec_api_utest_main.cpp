...
#define ECAES_SPECIFIC_TESTS(suite, con_key, asym_alg, wkfv) \
    do { \
...
#define ECAES_WKFV_TESTS(suite, con_key, asym_alg) \
    do { \
...
#define ECAES_ASYMALG_TESTS(suite, con_key) \
    do { \
        ECAES_WKFV_TESTS(suite, con_key, SEC_CIPHERALGORITHM_ECC_ELGAMAL); \
    } while (0)

#define ECAES_TESTS(suite) \
    do { \
...
#define OPAQUE_WITH_MAP_TESTS(suite, key, kc, loc) \
    do { \
\
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CTR, 1, 0)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CTR, 1, 16)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CTR, 1, 20)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CTR, 1, 256)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CTR, 2, 0)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CTR, 2, 16)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CTR, 2, 20)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CTR, 2, 256)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CTR, 5, 0)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CTR, 5, 16)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CTR, 5, 20)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CTR, 5, 256)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CTR, 10, 0)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CTR, 10, 16)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CTR, 10, 20)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CTR, 10, 256)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CBC_NO_PADDING, 1, 0)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CBC_NO_PADDING, 1, 16)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CBC_NO_PADDING, 1, 256)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CBC_NO_PADDING, 2, 0)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CBC_NO_PADDING, 2, 16)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CBC_NO_PADDING, 2, 256)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CBC_NO_PADDING, 5, 0)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CBC_NO_PADDING, 5, 16)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CBC_NO_PADDING, 5, 256)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CBC_NO_PADDING, 10, 0)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CBC_NO_PADDING, 10, 16)); \
        RUN_TEST(suite, testProcessOpaqueWithMap(SEC_OBJECTID_USER_BASE, key, kc, loc, \
                                SEC_CIPHERALGORITHM_AES_CBC_NO_PADDING, 10, 256)); \
\
...
void runWrappedTests(SuiteCtx* suite) { // NOLINT
    ...
    ECAES_TESTS(suite);
    RUN_TEST(suite,
            testWrappedKDFCMACAES128(SEC_OBJECTID_USER_BASE, SEC_OBJECTID_USER_BASE + 1, SEC_OBJECTID_USER_BASE + 2,
                    SEC_KEYTYPE_AES_128, 1, 256))
    RUN_TEST(suite,
            testWrappedKDFCMACAES128(SEC_OBJECTID_USER_BASE, SEC_OBJECTID_USER_BASE + 1, SEC_OBJECTID_USER_BASE + 2,
                    SEC_KEYTYPE_HMAC_128, 1, 256))
    RUN_TEST(suite,
            testExportedKDFCMACAES128(SEC_OBJECTID_USER_BASE, SEC_OBJECTID_USER_BASE + 1, SEC_OBJECTID_USER_BASE + 2,
                    SEC_KEYTYPE_AES_128, 1, 256))
    RUN_TEST(suite,
            testExportedKDFCMACAES128(SEC_OBJECTID_USER_BASE, SEC_OBJECTID_USER_BASE + 1, SEC_OBJECTID_USER_BASE + 2,
                    SEC_KEYTYPE_HMAC_128, 1, 256))
...
void runExchangeTests(SuiteCtx* suite) {
    RUN_TEST(suite, testKeyExchangeDH(SEC_OBJECTID_USER_BASE, SEC_STORAGELOC_RAM, SEC_KEYTYPE_AES_128, SEC_TRUE))
    RUN_TEST(suite, testKeyExchangeDH(SEC_OBJECTID_USER_BASE, SEC_STORAGELOC_RAM, SEC_KEYTYPE_AES_128, SEC_FALSE))
    if (TestCreds::supports(CAPABILITY_AES256)) {
        RUN_TEST(suite, testKeyExchangeDH(SEC_OBJECTID_USER_BASE, SEC_STORAGELOC_RAM, SEC_KEYTYPE_AES_256, SEC_TRUE))
        RUN_TEST(suite, testKeyExchangeDH(SEC_OBJECTID_USER_BASE, SEC_STORAGELOC_RAM, SEC_KEYTYPE_AES_256, SEC_FALSE))
    }
    RUN_TEST(suite, testKeyExchangeDH(SEC_OBJECTID_USER_BASE, SEC_STORAGELOC_RAM, SEC_KEYTYPE_HMAC_128, SEC_TRUE))
    RUN_TEST(suite, testKeyExchangeDH(SEC_OBJECTID_USER_BASE, SEC_STORAGELOC_RAM, SEC_KEYTYPE_HMAC_128, SEC_FALSE))
    RUN_TEST(suite, testKeyExchangeDH(SEC_OBJECTID_USER_BASE, SEC_STORAGELOC_RAM, SEC_KEYTYPE_HMAC_160, SEC_TRUE))
    RUN_TEST(suite, testKeyExchangeDH(SEC_OBJECTID_USER_BASE, SEC_STORAGELOC_RAM, SEC_KEYTYPE_HMAC_160, SEC_FALSE))

    RUN_TEST(suite, testKeyExchangeECDH(SEC_OBJECTID_USER_BASE, SEC_STORAGELOC_RAM, SEC_KEYTYPE_AES_128, SEC_TRUE))
    RUN_TEST(suite, testKeyExchangeECDH(SEC_OBJECTID_USER_BASE, SEC_STORAGELOC_RAM, SEC_KEYTYPE_AES_128, SEC_FALSE))
    if (TestCreds::supports(CAPABILITY_AES256)) {
        RUN_TEST(suite, testKeyExchangeECDH(SEC_OBJECTID_USER_BASE, SEC_STORAGELOC_RAM, SEC_KEYTYPE_AES_256, SEC_TRUE))
        RUN_TEST(suite, testKeyExchangeECDH(SEC_OBJECTID_USER_BASE, SEC_STORAGELOC_RAM, SEC_KEYTYPE_AES_256,
                                SEC_FALSE))
    }
    RUN_TEST(suite, testKeyExchangeECDH(SEC_OBJECTID_USER_BASE, SEC_STORAGELOC_RAM, SEC_KEYTYPE_HMAC_128, SEC_TRUE))
    RUN_TEST(suite, testKeyExchangeECDH(SEC_OBJECTID_USER_BASE, SEC_STORAGELOC_RAM, SEC_KEYTYPE_HMAC_128, SEC_FALSE))
    RUN_TEST(suite, testKeyExchangeECDH(SEC_OBJECTID_USER_BASE, SEC_STORAGELOC_RAM, SEC_KEYTYPE_HMAC_160, SEC_TRUE))
    RUN_TEST(suite, testKeyExchangeECDH(SEC_OBJECTID_USER_BASE, SEC_STORAGELOC_RAM, SEC_KEYTYPE_HMAC_160, SEC_FALSE))
}

#define RSA_SIGNATURE_TESTS(suite, pub, priv, kc, keySize) \
    do { \
...
#define EC_SIGNATURE_TESTS(suite, pub, priv, kc, keySize) \
    do { \
        RUN_TEST(suite, testSignature(SEC_OBJECTID_USER_BASE, pub, priv, kc, SEC_STORAGELOC_RAM, \
...
int testIt(int argc, char* argv[]) { // NOLINT
    int nParams = argc - 1;
    std::vector<int64_t> runParams;
    SEC_PRINT("Number of runParams: %d\n", nParams);
    for (int i = 1; i < (nParams + 1); ++i) {
        auto x = strtol(argv[i], nullptr, 0);
        runParams.push_back(x);
    }
    ...
    if (TestCreds::supports(CAPABILITY_CMAC_IN_HW)) {
        ...
        if (TestCreds::supports(CAPABILITY_AES256)) {
            MAC_TESTS(&suite, TESTKEY_AES256, TESTKC_RAW, SEC_STORAGELOC_RAM_SOFT_WRAPPED,
    ...
    if (TestCreds::supports(CAPABILITY_RSA_1024)) {
        ...
        RSA_DECRYPT_TESTS(&suite, TESTKEY_RSA1024_ENC_PUB, TESTKEY_RSA1024_ENC_PRIV, TESTKC_CONDITIONAL);
    }

    RSA_ENCRYPT_TESTS(&suite, TESTKEY_RSA2048_ENC_PUB, TESTKEY_RSA2048_ENC_PRIV, TESTKC_RAW);
    RSA_DECRYPT_TESTS(&suite, TESTKEY_RSA2048_ENC_PUB, TESTKEY_RSA2048_ENC_PRIV, TESTKC_CONDITIONAL);

    //sign
    if (TestCreds::supports(CAPABILITY_RSA_1024)) {
        RSA_SIGNATURE_TESTS(&suite, TESTKEY_RSA1024_SGN_PUB, TESTKEY_RSA1024_SGN_PRIV, TESTKC_CONDITIONAL, 128);
    }
    RSA_SIGNATURE_TESTS(&suite, TESTKEY_RSA2048_SGN_PUB, TESTKEY_RSA2048_SGN_PRIV, TESTKC_CONDITIONAL, 256);

    EC_SIGNATURE_TESTS(&suite, TESTKEY_EC_PUB, TESTKEY_EC_PRIV, TESTKC_CONDITIONAL, 128);
    ...
    SEC_PRINT("==============================================\n");
    SEC_PRINT("Test summary: %d/%d succeeded, %d skipped\n", suite.getSucceeded().size(), suite.getAttempted().size(),
            suite.getSkipped().size());

...
static Sec_Result process_rsa_key_container(Sec_KeyContainer in_key_container, const SEC_BYTE* data,
        SEC_SIZE data_length, unsigned char* key_buffer, SEC_SIZE* key_length, Sec_KeyContainer* key_container);

static Sec_Result process_rsa_public_key_container(Sec_KeyContainer in_key_container, const SEC_BYTE* data,
        SEC_SIZE data_length, RSA** rsa, unsigned char* key_buffer, SEC_SIZE* key_length,
        Sec_KeyContainer* out_key_container);

static Sec_Result process_ec_key_container(Sec_KeyContainer in_key_container, const SEC_BYTE* data,
        SEC_SIZE data_length, unsigned char* key_buffer, SEC_SIZE* key_length, Sec_KeyContainer* out_key_container);

static Sec_Result process_ec_public_key_container(Sec_KeyContainer in_key_container, const SEC_BYTE* data,
